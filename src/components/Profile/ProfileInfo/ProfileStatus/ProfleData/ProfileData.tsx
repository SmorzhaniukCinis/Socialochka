...
import {getStatus, getSubscription} from "../../../../../redux/Selectors/ProfileSelectors";
        ...
        <div className={s.profileInfo}>
            ...
            <div className={s.linkBlock}>
                ...
                <a href={props.profile.contacts.facebook || '#'}
                   className={props.profile.contacts.facebook || disabled}>
                    <img className={s.link} alt={'icon'}
                         src="https://img.icons8.com/metro/30/000000/facebook-new--v2.png"/>
                </a>
                <a href={props.profile.contacts.instagram || '#'}
                   className={props.profile.contacts.instagram || disabled}>
                    <img className={s.link} alt={'icon'}
                         src="https://img.icons8.com/metro/30/000000/instagram-new.png"/>
                </a>
